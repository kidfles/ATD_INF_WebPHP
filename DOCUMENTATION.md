...
> **💡 Instructies:** Screenshots kunnen worden toegevoegd volgens de instructies in `/public/screenshots/README.md`

#### **Key Features Visualisatie**

**1. Dashboard Overzicht**
```
┌─────────────────────────────────────────────────────────────┐
│  ATD Webshop Dashboard                              [User]  │
├──────────┬──────────────────────────────────────────────────┤
│          │  📊 Overzicht                                    │
│  Menu    │  ┌────────────┐ ┌────────────┐ ┌────────────┐  │
│  ────    │  │ Advertenties│ │  Verhuur  │ │  Biedingen │  │
│  🏠 Home │  │     12      │ │     5     │ │     3      │  │
│  📦 Ads  │  └────────────┘ └────────────┘ └────────────┘  │
│  📅 Agenda│                                                 │
│  ⚙️ Instellingen                                            │
│          │  📈 Recente Activiteiten                        │
│          │  • Product X verhuurd aan User Y                │
│          │  • Nieuwe bieding ontvangen (€250)              │
│          │  • Veiling eindigt over 2 dagen                 │
└──────────┴──────────────────────────────────────────────────┘
```

**2. Whitelabel Bedrijfspagina Editor**
```
┌─────────────────────────────────────────────────────────────┐
│  Bedrijfsinstellingen - TechHub NL                          │
├─────────────────────────────────────────────────────────────┤
│  🎨 Branding                                                │
│  ├─ Merkleur: [🔵 #3B82F6] ← Color Picker                  │
│  ├─ Custom URL: techhub-nl                                  │
│  └─ Logo: [📁 Upload]                                       │
│                                                              │
│  📄 Pagina Componenten (Drag & Drop)                        │
│  ┌────────────────────────────────────────────────────┐    │
│  │ [≡] Hero Banner          [Edit] [↑] [↓] [Delete]  │    │
│  │     Titel: "Professionele Gereedschap"             │    │
│  ├────────────────────────────────────────────────────┤    │
│  │ [≡] Text Block           [Edit] [↑] [↓] [Delete]  │    │
│  │     Content: "Wij verhuren..."                     │    │
│  ├────────────────────────────────────────────────────┤    │
│  │ [≡] Featured Ads         [Edit] [↑] [↓] [Delete]  │    │
│  │     Show: 6 items                                  │    │
│  └────────────────────────────────────────────────────┘    │
│  [+ Nieuw Component]                                        │
└─────────────────────────────────────────────────────────────┘
...
**3. Verhuurkalender (Agenda Dashboard)**
```
┌─────────────────────────────────────────────────────────────┐
│  Agenda - Februari 2026                    [◀ Vorige | Volgende ▶] │
├─────────────────────────────────────────────────────────────┤
│  Ma   Di   Wo   Do   Vr   Za   Zo                           │
│       01   02   03   04   05   06                           │
│  07   08  [09] [10] [11]  12   13    [09-11]: Boormachine  │
│  14  [15] [16] [17] [18]  19   20    [15-18]: Zaagmachine  │
│  21   22   23   24  [25]  26   27    [25]: Veiling eindigt │
│  28                                                          │
│                                                              │
│  Legenda:                                                    │
│  🟢 Verhuurperiode   🔴 Veiling Einddatum                   │
│                                                              │
│  📋 Details:                                                 │
│  • Boormachine - Verhuurd aan: Jan de Vries                 │
│    09-02-2026 tot 11-02-2026                                │
│  • Zaagmachine - Verhuurd aan: Maria Jansen                 │
│    15-02-2026 tot 18-02-2026 (Retour foto nodig)           │
└─────────────────────────────────────────────────────────────┘
```
...
│                                                              │
│  Stap 1: Download Contract Template                         │
│  [📥 Download PDF]  ← Generate contract met bedrijfsgegevens│
│                                                              │
│  Stap 2: Upload Getekend Contract                           │
│  [📤 Kies Bestand] contract-signed.pdf  [Upload]           │
│                                                              │
│  Stap 3: Admin Goedkeuring (Status: Pending)                │
│  Na goedkeuring krijg je toegang tot:                       │
│  • API Token Generatie                                      │
│  • CSV Bulk Import                                          │
│  • Extra Whitelabel Features                                │
│                                                              │
│  ⚙️ API Toegang                                              │
│  [Genereer Token] ← Disabled tot contract is goedgekeurd   │
└─────────────────────────────────────────────────────────────┘
```

**5. Advertentie Aanmaken (met Conditional Fields)**
```
┌─────────────────────────────────────────────────────────────┐
│  Nieuwe Advertentie                                         │
├─────────────────────────────────────────────────────────────┤
│  Titel: [Professional Boormachine 2000W                   ] │
│                                                              │
│  Beschrijving: [Krachtige boormachine voor professioneel.. ] │
│                                                              │
│  Prijs: [€ 45.00]  per dag                                  │
│                                                              │
│  Type: (•) Verkoop  ( ) Verhuur  ( ) Veiling  ← Alpine.js  │
│                                                              │
│  ⚠️ Einddatum: [2026-02-28] ← Verschijnt alleen bij Veiling │
│                                                              │
│  Gerelateerde Producten:                                    │
│  [✓] Boor Set (Verkoop)                                     │
│  [✓] Beschermende Handschoenen (Verkoop)                    │
│  [ ] Stofzuiger (Verhuur)                                   │
│                                                              │
│  Afbeelding: [📷 Upload] → Preview verschijnt rechts       │
│                                                              │
...
│                   ROUTING LAYER                             │
│  ┌────────────────────────────────────────────────────┐    │
│  │ web.php (Zone A: Public, Zone B: Dashboard, ...)  │    │
│  └────────────────────────────────────────────────────┘    │
│       ▼                                                      │
├─────────────────────────────────────────────────────────────┤
│                   MIDDLEWARE LAYER                          │
│  ┌──────────┐  ┌──────────┐  ┌──────────────────────┐    │
│  │ Auth     │  │ Verified │  │ EnsureContractApproved│    │
│  └──────────┘  └──────────┘  └──────────────────────┘    │
│       ▼                                                      │
├─────────────────────────────────────────────────────────────┤
│                  CONTROLLER LAYER                           │
│  ┌──────────┐  ┌──────────┐  ┌──────────┐  ┌──────────┐  │
│  │ Market   │  │ Advertisement│ Rental  │  │ Company  │  │
...
│  ┌──────────┐  ┌──────────┐  ┌──────────┐  ┌──────────┐  │
│  │ User     │  │ Advertisement│ Rental  │  │ Company  │  │
│  │          │  │          │  │          │  │ Profile  │  │
│  └──────────┘  └──────────┘  └──────────┘  └──────────┘  │
│       ▼              ▼              ▼              ▼        │
├─────────────────────────────────────────────────────────────┤
│                    DATABASE LAYER                           │
│  ┌────────────────────────────────────────────────────┐    │
│  │ MySQL/SQLite (Foreign Keys, Indexes, Constraints) │    │
│  └────────────────────────────────────────────────────┘    │
└─────────────────────────────────────────────────────────────┘
```
...
Nadat de applicatie is opgezet met `php artisan serve`, zijn de volgende demo pagina's beschikbaar:

1. **Homepage**: `http://localhost:8000/` - Featured advertenties
2. **Marktplaats**: `http://localhost:8000/market` - Volledige catalogus met filters
3. **Bedrijfspagina**: `http://localhost:8000/company/techhub-nl` - Whitelabel voorbeeld
4. **Dashboard**: `http://localhost:8000/dashboard` - Na inloggen

**Test Accounts** (wachtwoord: `password`):
- Zakelijk: `info@techhub.nl`
- Particulier: `john@example.com`
- Koper: `user@example.com`
